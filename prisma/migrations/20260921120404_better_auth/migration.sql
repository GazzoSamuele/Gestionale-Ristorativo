/*
  ...
  - A unique constraint covering the columns `[email]` on the table `Utente` will be added. If there are existing duplicate values, this will fail.
  - Added the required column `email` to the `Utente` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "Utente" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
